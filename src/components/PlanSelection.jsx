...
export default function PlanSelection({ plans, onChange, label = '' }) {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div className="border border-gray-200 rounded-xl overflow-hidden bg-white">
        <div className="flex items-center gap-2.5 px-4 py-3 bg-blue-50/60 border-b border-blue-100">
          ...
          <span className="text-xs text-gray-500">Group Mediclaim</span>
        </div>
      ...
      <div className="border border-gray-200 rounded-xl overflow-hidden bg-white">
        <div className="flex items-center gap-2.5 px-4 py-3 bg-violet-50/60 border-b border-violet-100">
          ...
          <span className="text-xs text-gray-500">Group Personal Accident</span>
        </div>
