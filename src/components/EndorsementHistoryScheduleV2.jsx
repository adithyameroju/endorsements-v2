...
import { dropdownChevronClass, selectNativeChevronClass } from '../lib/formUi'
...
const SCHEDULE_TOOLBAR_SELECT_CLASS =
  `min-h-[1.75rem] cursor-pointer rounded-lg border border-gray-200 bg-white py-1 pl-2.5 text-xs text-gray-900 hover:border-gray-300 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 ${selectNativeChevronClass}`
  ...
  return (
    <div ref={rootRef} className="relative shrink-0">
      ...
      >
        ...
        <ChevronDown size={14} className={`${dropdownChevronClass} text-gray-500 transition-transform ${open ? 'rotate-180' : ''}`} aria-hidden />
      </button>
      {open ? (
        <div
          role="listbox"
